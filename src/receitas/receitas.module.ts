...
@Module({
    imports: [TypeOrmModule.forFeature([Receita]), IngredientesModule],
    controllers: [ReceitasController, IngredientesController],
    providers: [ReceitasService, IngredientesService]
})
